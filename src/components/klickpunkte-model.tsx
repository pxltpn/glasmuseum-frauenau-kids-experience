  ...
  return (
    <div className="w-full h-[300px] flex flex-col flex-grow overflow-hidden relative">
      ...
      <model-viewer
        ...
        src="https://glasmuseum-frauenau.de/wp-content/uploads/models/glasmuseum-3.glb"
        ar-modes="webxr scene-viewer quick-look"
        camera-controls=""
        // environment-image="/model/lightroom_14b.hdr"
        environment-image="https://glasmuseum-frauenau.de/wp-content/uploads/models/lightroom_14b.hdr"
        shadow-intensity="1"
        ar-status="not-presenting"
      ></model-viewer>
      <div>
        <div className="px-[10vw] py-[4vw] w-full h-full bg-white bg-opacity-80 text-slate-900 flex flex-col space-y-[3vw]">
